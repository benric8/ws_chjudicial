...
/**
 * <pre>
 * Objeto     : ConsultaPrisionPreventivaPorDniCallable.
 * Descripción: Clase que permite realizar las consultas de prisión preventiva  por DNI de forma concurrente.
 * Fecha      : 2022-07-15
 * Autor      : CALTAMIRANOME
 * ----------------------------------------------------------------------------------------------------------------------
 ...
 * </pre>
 */
public class ConsultaPrisionPreventivaPorDniCallable implements Callable<List<PrisionPreventivaDTO>> {
	...
	public ConsultaPrisionPreventivaPorDniCallable(String cuo, String numeroDocumento, DataSourceDTO dataSource, ConsultaPrisionPreventivaDao consultaPrisionPreventivaDao) {
		this.cuo = cuo;
	...
	public List<PrisionPreventivaDTO> call() throws Exception {
		return consultaPrisionPreventivaDao.consultaPorDni(cuo, numeroDocumento, dataSource);
	}
